...
//                        + aMapLocation.getErrorInfo());
     ...
     * @return
     */
    public MarkerOptions getMarkerOption(String str, double lat, double lgt, Activity activity){
        MarkerOptions markerOptions = new MarkerOptions();

        markerOptions.icon(BitmapDescriptorFactory.fromView(activity.getLayoutInflater().inflate(R.layout.icon,null)));
